...
<div id="reacg_settings" class="reacg-elementor-options reacg-wrapper"></div>',
    ...
    $this->add_control(
      ...
      [
        'type' => \Elementor\Controls_Manager::RAW_HTML,
        'raw' => '<div class="reacg-fake-container reacg-wrapper reacg-gallery reacg-preview" id="reacg_fake_container" data-options-container="#reacg_fake_container" data-gallery-id="0" style="display: none;"></div>',
  ...
  protected function render() {
    ...
    echo REACGLibrary::get_rest_routs($post_id, $widget_id);

    if ( is_admin() ) {
      echo '<script type="text/javascript">';
      echo 'parent.reacg_reload_gallery("' . esc_js($widget_id) . '", "' . esc_js($post_id) . '", false);';
      echo '</script>';
    }
  }
}
