...
class REACG_Deactivate {
  ...
  function action_links( $links ) {
    $additional_links = [
      ...
      "<a href='" . esc_url(add_query_arg(['utm_medium' => 'plugins_list', 'utm_campaign' => 'black_friday'], REACG_WEBSITE_URL_UTM . '/#pricing')) . "' target='_blank' class='reacg-upgrade'>" . esc_html__('Get Discount Now', 'reacg') . "</a>",
    ];
